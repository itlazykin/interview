...
Это класс, помеченный аннотацией `@Entity`, нужен для маппинга Java объектов в БД и наоборот. Она должна соответствовать следующим условиями:
...
Возникает, когда приложение делает избыточное количество SQL-запросов к базе данных для загрузки связанных сущностей.
